(() => {
  ...
  var dt2 = (e, r, t) => r in e ? Ct(e, r, { enumerable: true, configurable: true, writable: true, value: t }) : e[r] = t;
  var Ce = (e, r) => {
    for (var t in r || (r = {}))
  ...
  var St = (e, r, t) => (dt2(e, typeof r != "symbol" ? r + "" : r, t), t);
...
`));
  ...
  scene("game", ({ level, score }) => {
    ...
    action("slicer", (s2) => {
      s2.move(s2.dir * SLICER_SPEED, 0);
    });
    collides("slicer", "wall", (s2) => {
      s2.dir = -s2.dir;
    });
    action("skeletor", (s2) => {
      s2.move(0, s2.dir * SKELETOR_SPEED);
      s2.timer -= dt();
      if (s2.timer <= 0) {
        s2.dir = -s2.dir;
        s2.timer = rand(5);
